...
<div
  class={`transform hover:shadow-hover transition duration-100 ease-in shadow-featured bg-white p-4 rounded-md custom-flex-span-${post.primary_tag.slug === 'erbjudande' ? 'wide' : 'narrow'}`}
  style="height: 600px;">
  <a
    rel="prefetch"
