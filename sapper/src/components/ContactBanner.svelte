...
<div
  class="bg-grey-medium flex flex-col md:flex-row justify-center items-center
  text-white w-screen py-20 md:py-32">
  ...
  <div
    class="w-screen md:w-1/3 lg:w-1/4 flex justify-center md:ml-8 mt-6 md:mt-0
    px-16 md:px-0">
